...
const Report: FC = () => {
  ...
  const sentReport = () => {
    const newValues:any = {}
    for (const key in updateValues) newValues[key] = new Date(updateValues[key]).getTime()
          ...
          <View style={[styles.mainInputContainer]}>
            <View
              ...
              <DatePicker
                ...
                mode={'date'}
                onChange={(date: any) => {
                  if (new Date(date?.nativeEvent?.text).getTime() < new Date(updateValues?.to_date).getTime()) setUpdateValues((prev: any) => ({
                    ...prev,
          ...
          <View style={[styles.mainInputContainer]}>
            <View
              ...
              <DatePicker
                ...
                mode={'date'}
                onChange={(date: any) => {
                  if (new Date(date?.nativeEvent?.text).getTime() > new Date(updateValues?.from_date).getTime()) setUpdateValues((prev: any) => ({
                    ...prev,
