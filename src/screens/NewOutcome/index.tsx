...
import {createOutcome, getAccounts, getCurrencies} from 'store/actions'
...
const NewOutcome: FC = () => {
  ...
  const createData = () => {
    ...
    dispatch(createOutcome(sendValues))
    navigation.goBack()
  }

  return (
    <View style={[styles.root, {backgroundColor: colors.background100}]}>
      <BackHandler title={translate('new_outcome')} />
