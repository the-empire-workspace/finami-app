...
const NewFixedOutcome: FC = () => {
  ...
  const createData = () => {
    ...
    if (categoryCreation) {
      dispatch(
        createOutcomeCategory({...sendValues, category_id: params?.id || null}),
      )
      navigation.goBack()
      return
    }
  ...
  return (
    <View style={[styles.root, {backgroundColor: colors.background100}]}>
      <BackHandler title={translate('new_basic_expenses')} />
...
export default NewFixedOutcome
