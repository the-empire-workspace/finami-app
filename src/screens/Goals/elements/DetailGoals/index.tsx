    ...
    <View style={[styles.root, { backgroundColor: colors.background100 }]}>
      ...
      <View style={[styles.mainInfo, { backgroundColor: colors.background50 }]}>
        ...
        <View style={[styles.actionContent]}>
          <TouchableOpacity style={[styles.action]} onPress={() => { navigation.navigate('report', { type: params?.type === 'category' ? `${params?.itemType}_category` : `${params?.itemType}_detail`, id: item?.id }) }}>
