  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background100 }]}>
      ...
      <View style={[styles.mainInfo, { backgroundColor: colors.background50 }]}>
        ...
        {params?.type !== 'category' && <View style={[styles.progressContainer]}>
          ...
          {!shortInfo && <View
            style={[
              ...
              { borderColor: params?.itemType === 'compromise' ? colors.progress.needs : colors.progress.wish },
            ]}>
            <View
              style={[
                styles.progress,
                {
                  backgroundColor: params?.itemType === 'compromise' ? colors.progress.needs : colors.progress.wish,
        ...
        <View style={styles.actions}>
          ...
          <View>
            <Button
              ...
              style={[{ backgroundColor: params?.itemType === 'compromise' ? colors.progress.needs : colors.progress.wish }]}
              styleText={{ color: colors.typography2 }}
              onPress={() => {
                if (params?.type === 'category') return navigation.navigate('newGoals', {
                  type: params?.type,
                  id: params?.id,
