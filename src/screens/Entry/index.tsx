      ...
      <View style={[styles.modal, { backgroundColor: colors.background100 }]}>
        ...
        <ScrollView
          ...
          <View style={[styles.textContent]}>
            ...
            <Text style={[styles.smallBody, { color: colors.typography }, styles.textWidth]}>
          ...
          {!!item?.account_name && (
            <View
              ...
              <View
                ...
                <Text
                  style={[styles.smallBody, { color: colors.typography }, styles.textWidth]}>{`${item?.account_name
                    }${item?.account_number
              ...
              <View
                ...
                {!!item?.emissor && (
                  <View style={[styles.textContent]}>
                    ...
                    <Text
                      style={[styles.smallBody, { color: colors.typography }, styles.textWidth]}>
