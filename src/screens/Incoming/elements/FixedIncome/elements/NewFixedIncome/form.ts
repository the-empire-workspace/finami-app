...
export const NewEntryForm = (
...
) => [
  {
    ...
    type: 'text',
    defaultValue: def?.account?.value || '',
  ...
  },
  {
    ...
    labelStyle: {backgroundColor: colors.background100},
    type: 'text',
    defaultValue: def?.payment_concept?.value || '',
    keyboardType: 'default',
...

  {
    ...
    labelStyle: {backgroundColor: colors.background100},
    type: 'text',
    defaultValue: def?.frecuency_type?.value || 'days',
  ...
  },
  {
    ...
    labelStyle: {backgroundColor: colors.background100},
    type: 'text',
    defaultValue: def?.frecuency_time?.value || '1',
    keyboardType: 'number-pad',
    placeholder: '1',
    returnKeyType: 'go',
    placeholderTextColor: color,
  ...
  },
  {
    ...
    labelStyle: {backgroundColor: colors.background100},
    type: 'text',
    defaultValue: def?.emissor?.value || '',
    keyboardType: 'default',
