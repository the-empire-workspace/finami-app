  ...
  return (
    <View style={[styles.root]}>
      <View style={[styles.infoBox]}>
        <Text style={[styles.strongBody, styles.centerText, { color: values?.month1?.color }]}>
          {currency?.symbol || ''}{' '}
      ...
      {!!values?.month2 && (
        <View style={[styles.infoBox]}>
          <Text style={[styles.strongBody, styles.centerText,{ color: values?.month2?.color }]}>
            {currency?.symbol || ''}{' '}
      ...
      <View style={[styles.infoBox]}>
        <Text style={[styles.strongBody, styles.centerText, { color: colors.states.caution }]}>
          {currency?.symbol || ''}{' '}
