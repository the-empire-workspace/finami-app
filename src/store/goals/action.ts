...
export const getEntriesGoals = (type: any) =>
  actionObject(GET_ENTRIES_GOALS, type)

export const createGoals = (data: any) => actionObject(CREATE_GOALS, data)
export const createCategoryGoals = (data: any) =>
  actionObject(CREATE_CATEGORY_GOALS, data)
...
export const createGoalEntry = (data: any) =>
  actionObject(CREATE_GOAL_ENTRY, data)

export const updateGoal = (data: any) => actionObject(UPDATE_GOAL, data)
export const updateCategoryGoal = (data: any) =>
  actionObject(UPDATE_CATEGORY_GOAL, data)

export const deleteGoal = (data: any) => actionObject(DELETE_GOAL, data)
export const deleteCategoryGoal = (data: any) =>
  actionObject(DELETE_CATEGORY_GOAL, data)
